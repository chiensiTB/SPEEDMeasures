...
class Output
  ...
  :geo_coords,:demandEndUseComponentsSummaryTable,:sourceEnergyUseComponentsSummary
  ...
  def to_hash
    { 'user_id' => @user_id, 'os_model_id' => @os_model_id, 'sql_path'=>@sql_path, 'created_timestamp'=>@created_timestamp,'building_type'=>@building_type,'climate_zone'=>@climate_zone, 'geometry_profile'=>@geometry_profile, 'openStudio_model_name'=>@openStudio_model_name, 'input_variables'=>@input_variables.to_hash,'output_variables'=>@output_variables.to_hash,
      'EUI'=>@EUI, 'EUI_units'=>@EUI_units, 'daylight_autonomy'=>@daylight_autonomy, 'geo_coords'=>@geo_coords.to_hash,'demandEndUseComponentsSummaryTable'=>@DemandEndUseComponentsSummaryTable.to_hash,'sourceEnergyUseComponentsSummary'=>@sourceEnergyUseComponentsSummary.to_hash }
  end
end
